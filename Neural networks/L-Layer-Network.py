...
def L_model_backward(AL, Y, caches):
    ...
    grads["dA" + str(L)], grads["dW" + str(L)], grads["db" + str(L)] = linear_activation_backward_softmax(AL, Y,
                                                                                                          current_cache,
                                                                                                          activation="softmax")
    ### END CODE HERE ###
    ...
    for l in reversed(range(L - 1)):
        ...
        dA_prev_temp, dW_temp, db_temp = linear_activation_backward_relu(grads["dA" + str(L)], current_cache,
                                                                         activation="relu")
